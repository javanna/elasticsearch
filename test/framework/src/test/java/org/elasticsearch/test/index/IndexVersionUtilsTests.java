...
public class IndexVersionUtilsTests extends ESTestCase {
    /**
     * Tests that {@link IndexVersions#MINIMUM_WRITE_COMPATIBLE} and {@link IndexVersionUtils#allReleasedVersions()}
    ...
    public void testGradleVersionsMatchVersionUtils() {
        ...
        List<IndexVersion> released = IndexVersionUtils.allReleasedVersions()
            ...
            .filter(v -> v.onOrAfter(IndexVersions.MINIMUM_WRITE_COMPATIBLE))
            .toList();
