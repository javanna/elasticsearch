...
/**
 * Action listener that is internally used to monitor progress of a search request, so that the provided {@link ActionListener} and
 * {@link SearchProgressListener} are combined into one action listener implementation.
 */
final class SearchProgressActionListener implements ActionListener<SearchResponse>, SearchProgressListener {
    ...
    ActionListener<SearchResponse> getDelegate() {
        return delegate;
    }
}
