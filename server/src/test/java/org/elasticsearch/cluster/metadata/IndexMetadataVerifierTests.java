...
public class IndexMetadataVerifierTests extends ESTestCase {
    ...
    public void testCustomSimilarity() {
        ...
        service.verifyIndexMetadata(src, IndexVersions.MINIMUM_WRITE_COMPATIBLE);
    }

    public void testIncompatibleVersion() {
        IndexMetadataVerifier service = getIndexMetadataVerifier();
        IndexVersion minCompat = IndexVersions.MINIMUM_WRITE_COMPATIBLE;
        ...
        String message = expectThrows(
            ...
            () -> service.verifyIndexMetadata(metadata, IndexVersions.MINIMUM_WRITE_COMPATIBLE)
        ).getMessage();
        assertThat(
            message,
            equalTo(
        ...
        service.verifyIndexMetadata(goodMeta, IndexVersions.MINIMUM_WRITE_COMPATIBLE);
    }
