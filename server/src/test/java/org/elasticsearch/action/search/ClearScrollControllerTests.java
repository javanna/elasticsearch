...
public class ClearScrollControllerTests extends ESTestCase {
    ...
    public void testClearScrollIds() throws IOException, InterruptedException {
        ...
        testSearchPhaseResult1.setSearchShardTarget(new SearchShardTarget("node_1", new ShardId("idx", "uuid1", 2), null, null, null));
        ...
        testSearchPhaseResult2.setSearchShardTarget(new SearchShardTarget("node_2", new ShardId("idy", "uuid2", 42), null, null, null));
        ...
        testSearchPhaseResult3.setSearchShardTarget(new SearchShardTarget("node_3", new ShardId("idy", "uuid2", 43), null, null, null));
