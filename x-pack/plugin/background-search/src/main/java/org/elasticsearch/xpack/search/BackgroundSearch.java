...
public final class BackgroundSearch extends Plugin implements ActionPlugin {
    ...
    public List<NamedWriteableRegistry.Entry> getNamedWriteables() {
        return singletonList(
            new NamedWriteableRegistry.Entry(Task.Status.class, TransportSubmitBackgroundSearchAction.BackgroundSearchStatus.NAME,
                TransportSubmitBackgroundSearchAction.BackgroundSearchStatus::new));
    }
