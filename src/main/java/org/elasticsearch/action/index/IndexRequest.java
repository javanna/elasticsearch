...
public class IndexRequest extends ShardReplicationOperationRequest<IndexRequest> {
    ...
    IndexRequest concreteIndex(String concreteIndex) {
    ...
    public void process(MetaData metaData, @Nullable MappingMetaData mappingMd, boolean allowIdGeneration) throws ElasticsearchException {
        process(metaData, mappingMd, allowIdGeneration, concreteIndex);
    }
