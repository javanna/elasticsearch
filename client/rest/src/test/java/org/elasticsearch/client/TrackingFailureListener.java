...
/**
 * {@link AbstractRestClient.FailureListener} impl that allows to track when it gets called
 */
class TrackingFailureListener extends AbstractRestClient.FailureListener {
